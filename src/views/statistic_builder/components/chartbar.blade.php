    ...
    <form method='post'>
        ...
        <div class="form-group">
            ...
            <div class="block-help">
                Use column name 'label' as line chart label. Use name 'value' as value of line chart. Sparate with ;
                each sql line. Use [SESSION_NAME] to use
                alias session.
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <input class="form-control" required name='config[area_name]' type='text'
